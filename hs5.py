...
def classify_hs(message:str, protected_characteristics_str:str, HS_definition:str, examples:str):
    ...
    model="gpt-3.5-turbo",
    temperature = 0.0, #for more reproducible results
    messages=[
